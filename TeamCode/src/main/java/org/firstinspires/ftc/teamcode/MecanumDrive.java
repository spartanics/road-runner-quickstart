...
public final class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 0.00265420957;
        public double lateralInPerTick =  0.0018644577260467105;
        public double trackWidthTicks = 5036.202782862112;

        // feedforward parameters (in tick units)
        public double kS = 1.2201547971841777;
        public double kV = 0.0005666413851225644;
    ...
    public final VelConstraint slightlSlowerVelConstraint =
            new MinVelConstraint(Arrays.asList(
                    kinematics.new WheelVelConstraint(PARAMS.maxWheelVel * 0.6),
                    new AngularVelConstraint(PARAMS.maxAngVel * 0.6)
            ));
